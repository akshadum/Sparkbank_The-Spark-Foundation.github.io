...
<head>
	...
	.fitem1
	{
		background: linear-gradient(to right, #ffc653 0%, #ffc653 37%, #e9f3ff 36%, #e9f3ff 100%);
		margin: 18px;
		border: 10px;
		width: 710px;
		height: 325px;
	...
	.fitem2
	{
		background: linear-gradient(to right, #ff3f4a 0%, #ff3f4a 37%, #e9f3ff 36%, #e9f3ff 100%);
		margin: 18px;
		border: 2px;
		width: 710px;
		height: 325px;
	...
	.fitem3
	{
		background: linear-gradient(to right, #609fad 0%, #609fad 37%, #e9f3ff 36%, #e9f3ff 100%);
		margin: 18px;
		border: 2px;
		width: 710px;
		height: 325px;
	...
	.fitem4
	{
		background: linear-gradient(to right, #438aa8 0%, #438aa8 37%, #e9f3ff 36%, #e9f3ff 100%);
		margin: 18px;
		border: 2px;
		width: 710px;
		height: 325px;
				...
				<div class="frowcontainer">
					<div>
						...
						<div>
							...
							<br>
							<p></p>
							&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<p class="button4"><a href="spark.php"style="text-decoration: none; color:#438aa8"><strong>LEARN MORE</strong></a></p><br>
